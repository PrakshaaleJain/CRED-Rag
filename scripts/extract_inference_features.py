...
def process_company(row, out_dir, trees_dir, model_id, topic_embeddings, embedder, api_url):
    ...
    # No skip logic here, we want to process all unrated inference companies.
...
def main():
    out_dir = project_root / 'data' / 'inference_features'
    out_dir.mkdir(parents=True, exist_ok=True)
    
    labels_csv = project_root / 'data' / 'unrated_inference_set.csv'
    trees_dir = project_root / 'data' / 'inference_trees_directory'
