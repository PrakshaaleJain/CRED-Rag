...
def main():
    ...
    features_dir = project_root / 'data' / 'naive_qualitative_features'
    
    csv_out = project_root / 'data' / 'naive_sentiment_scores.csv'
    json_out = project_root / 'data' / 'naive_sentiment_scores.json'
    ...
    logging.info("Collecting naive qualitative text from JSON files...")
